...
const page = () => {
  ...
  const getRandomColor = () => {
    const colors = ['bg-blue-300', 'bg-blue-400', 'bg-blue-500', 'bg-blue-600', 'bg-blue-700', 'bg-blue-800', 'bg-blue-900'];
      ...
      <div className="first grid grid-cols-1 md:grid-cols-2 mt-6">
        <div className='flex rounded-md bg-white border-2 border-gray-200 shadow-sm h-auto m-3 p-5'>
            ...
            <div className='flex flex-col p-2'>
              <h1 className='font-medium text-lg m-2'>Hello, <span className='font-bold text-xl'>Firstname</span></h1>                  
              <TodayDate />
            </div>
        ...
        <div className='h-[300px] grid grid-cols-1 md:grid-cols-2'>
          <div className='rounded-md bg-white border-2 border-gray-200 shadow-sm m-3 p-4'>
              ...
              <div className='relative flex justify-center items-center mt-12'>
                <div className={`absolute w-28 h-28 ${getRandomColor()} rounded-full flex items-center justify-center`} style={{ top: '1%', left: '5%' }}>
                  <span className='text-white text-lg'>Type 1</span>
                </div>
                <div className={`absolute w-24 h-24 ${getRandomColor()} rounded-full flex items-center justify-center`} style={{ top: '5%', right: '10%' }}>
                  <span className='text-white text-lg'>Type 2</span>
                </div>
                <div className={`absolute w-20 h-20 ${getRandomColor()} rounded-full flex items-center justify-center`} style={{ top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}>
        ...
        <div className='rounded-md bg-white border-2 border-gray-200 shadow-sm m-3 p-4 h-[300px]'>
          <div className='flex flex-row'>
              <h1 className='font-semibold text-lg m-2'>Patient Chats</h1>  
               ...
               <span
                  className="ml-auto m-2 h-6 flex items-center text-purple-600 text-2xl cursor-pointer"
                >
                  <IoIosSend />
                </span>
          ...
          <div className='flex-grow overflow-y-auto p-2'>
            ...
            <div className='flex items-start mb-3'>
              ...
              <div className='bg-gray-100 p-2 rounded-md'>
                <p className='text-sm'>Hello, i am feeling anxiety and need help</p>
              </div>
            </div>
            {/* Message 2 */}
            <div className='flex items-start mb-3'>
