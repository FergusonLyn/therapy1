...
const RegisterStudent = () => {
  return (
    ...
    <div className='flex  flex-col rounded-lg bg-[#ffffff] p-7 w-[470px] relative '>
        ...
        <input className='input' placeholder='Enter your full name...'/> <label htmlFor="" className=''>Student Id</label>
        ...
        <p className='text-center text-[13px]'>Already have an account? <Link href="./getstarted" className='text-black font-bold'>Sign In</Link></p>
    </div>
    </div>
  )
}
