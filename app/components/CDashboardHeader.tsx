...
const CDashboardHeader = () => {
  ...
  return (
    <>
      <div>
        <div
          className={`navbar w-full bg-blue-800 font-normal text-white text-sm p-4 md:p-6 flex justify-between items-center transition-all duration-500 ${
            isSticky
              ? "fixed top-0 left-0 w-full shadow-lg z-50 rounded-none transition-all duration-500"
              : "rounded-md "
          }`}
        >
